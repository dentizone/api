        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "GETUTCDATE()"),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    Domain = table.Column<string>(type: "nvarchar(48)", maxLength: 48, nullable: false),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false, defaultValue: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShipInfoId = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false, defaultValue: false)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    FingerprintToken = table.Column<string>(type: "nvarchar(512)", maxLength: 512, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Stars = table.Column<int>(type: "int", nullable: false, defaultValue: 5),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ShipmentActivity", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ShipmentActivity_Orders_OrderId",
                        column: x => x.OrderId,
                        principalTable: "Orders",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    PostId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    AskerId = table.Column<string>(type: "nvarchar(450)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_WalletActivity", x => x.Id);
                    table.ForeignKey(
                        name: "FK_WalletActivity_Wallets_WalletId",
                        column: x => x.WalletId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Amount = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    Status = table.Column<string>(type: "nvarchar(max)", nullable: false, defaultValue: "Pending"),
                    ProcessingFee = table.Column<decimal>(type: "decimal(18,2)", nullable: true, defaultValue: 0.0m),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SalesTransaction_Payments_PaymentId",
                        column: x => x.PaymentId,
                        principalTable: "Payments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SalesTransaction_Wallets_WalletId",
                        column: x => x.WalletId,
                        principalTable: "Wallets",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    OrderId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    PickupId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_OrderPickups", x => x.Id);
                    table.ForeignKey(
                        name: "FK_OrderPickups_Orders_OrderId",
                        column: x => x.OrderId,
                        principalTable: "Orders",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ReviewUxes_OrderId",
                table: "ReviewUxes",
                column: "OrderId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ReviewUxes_UserId",
                table: "ReviewUxes",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_SalesTransaction_PaymentId",
                table: "SalesTransaction",
                column: "PaymentId");

            migrationBuilder.CreateIndex(
                name: "IX_SalesTransaction_WalletId",
                table: "SalesTransaction",
                column: "WalletId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ShipmentActivity_OrderId",
                table: "ShipmentActivity",
                column: "OrderId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WalletActivity_WalletId",
                table: "WalletActivity",
                column: "WalletId");
