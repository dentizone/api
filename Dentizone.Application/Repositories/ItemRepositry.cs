...
namespace Dentizone.Application.Repositories
{
    ...
    internal class ItemRepositry :AbstractRepository, IItemRepositry
    {
        ...
        {
            var items =await DbContext.Set<Item>().Where(i => i.Id == id.ToString() &&  !i.IsDeleted).FirstOrDefaultAsync();
            return  items;
        }
